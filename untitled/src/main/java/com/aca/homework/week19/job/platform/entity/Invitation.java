...
public class Invitation {
    ...
    @ManyToOne
    @JoinColumn(name = "user_id", foreignKey = @ForeignKey(name = "FK_INVITATIONS_USER_ID_USERS_ID"), nullable = false)
    private User user;

    @ManyToOne
    @JoinColumn(name = "organization_id", foreignKey = @ForeignKey(name = "FK_INVITATIONS_ORGANIZATION_ID_ORGANIZATIONS_ID"), nullable = false)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(user, that.user) && Objects.equals(organization, that.organization) && Objects.equals(status, that.status);
    }
