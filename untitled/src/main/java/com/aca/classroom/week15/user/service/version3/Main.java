...
import com.aca.classroom.week15.user.service.version3.service.impl.DiplomaServiceImpl;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        UniversityFacade universityFacade = new UniversityFacadeImpl(new UserServiceImpl(userRepository),
                new DiplomaServiceImpl(diplomaRepository, new UserServiceImpl(userRepository)));
