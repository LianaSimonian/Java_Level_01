...
class SimpleCalculatorTest {
    ...
    public void testWhenOperationIsSum() {
        ...
        Assertions.assertEquals("6.0", testSubject.askAndCalculate());
    }
    ...
    public void testWhenOperationIsSubtraction() {
        ...
        Assertions.assertEquals("4.0", testSubject.askAndCalculate());
    }
    ...
    public void testWhenOperationIsMultiplication() {
        ...
        Assertions.assertEquals("12.0", testSubject.askAndCalculate());
    }
}